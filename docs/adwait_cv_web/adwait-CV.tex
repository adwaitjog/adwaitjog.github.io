...
are: MICRO, ISCA, HPCA, ASPLOS, PACT, SIGMETRICS, DAC (European version of it is called DATE). The
...
\subsubsection*{PUBLICATIONS (After Joining W\&M)}
\hrule
\vspace{0.2cm}
...
\subsubsection*{PUBLICATIONS (Before Joining W\&M)}
\hrule
\vspace{0.2cm}
