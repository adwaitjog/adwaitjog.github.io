...
\vspace{0.2cm}
\begin{itemize}
\item  NSF SHF Award 2017 (PI, Award Amount: \$449,999)
\item  NSF CRII Award 2017 (sole PI, Award Amount: \$175,000)
\item  NVIDIA Hardware Grant (Jetson TX1), 2017
...
are: MICRO, ISCA, HPCA, ASPLOS, PACT, SIGMETRICS, DAC. The acceptance rate of all these premier conferences 
is around 20\%. \\
...
\item {\bf Undergraduate Students:}  Colin Weinshenker (Honors)
\end{itemize}
...
\begin{itemize}
	...
	\item Departmental Awards and Prizes Committee, 2017 - Present
...
\vspace{0.2cm}
\begin{itemize}
	\item NSF Panelist: 2017 (thrice), 2016 (once)
	\item External Program Committee Member, MICRO 2017
